# Generated by Django 4.1.5 on 2023-02-26 09:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='women',
            options={'ordering': ['-time_create', 'title'], 'verbose_name': 'Интересные персонажы', 'verbose_name_plural': 'Интересные персонажы'},
        ),
